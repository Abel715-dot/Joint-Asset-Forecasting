...
class DecoderLayer(nn.Module):
    ...
    '''
    def __init__(self, rank, seg_len, d_model, n_heads, d_ff=None, dropout=0.1, out_seg_num = 10, factor = 10):
        super(DecoderLayer, self).__init__()
        self.self_attention = TwoStageAttentionLayer(rank, out_seg_num, factor, d_model, n_heads, \
                                d_ff, dropout)    
...
class Decoder(nn.Module):
    ...
    '''
    def __init__(self, rank, seg_len, d_layers, d_model, n_heads, d_ff, dropout,\
        ...
        for i in range(d_layers):
            self.decode_layers.append(DecoderLayer(rank, seg_len, d_model, n_heads, d_ff, dropout, \
                                        out_seg_num, factor))
