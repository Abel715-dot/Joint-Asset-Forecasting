...
class Crossformer(nn.Module):
    def __init__(self, rank, data_dim, in_len, out_len, seg_len, win_size = 4,
        ...
        # Encoder
        self.encoder = Encoder(rank, e_layers, win_size, d_model, n_heads, d_ff, block_depth = 1, \
        ...
        self.decoder = Decoder(rank, seg_len, e_layers + 1, d_model, n_heads, d_ff, dropout, \
