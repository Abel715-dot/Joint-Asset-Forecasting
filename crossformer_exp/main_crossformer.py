...
parser.add_argument('--d_model', type=int, default=4, help='dimension of hidden states (d_model)')
...
parser.add_argument('--rank', type=float, default=0.5, help='rank of factorized tensors')
